...
export const cartAdapter: EntityAdapter<ProductEntity> = createEntityAdapter<ProductEntity>();
...
const cartReducer = createReducer(
  initialState, on(CartActions.addItem, (state, { item }) => {
